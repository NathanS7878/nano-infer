...
| + CUDA-graph decode | ✅ Landed | Eager decode was host-bound (3,200 dispatches, 65 syncs/step). Static sync-free step + graph capture: **decode 5.3–5.5× (short ctx), 4.0–4.2× (long)**, weights streamed at **60% of peak** (was 10.9%). Syncs alone: 1.00–1.20×. Reused runner (capture once): 3.6–4.6× end to end. Quantization re-measured under graphs: INT8 1.35× / INT4 1.42× at batch 1, but INT4 **0.16×** at batch 32. Contended-GPU runs, ratios only. See PROGRESS 2026-09-16 |
