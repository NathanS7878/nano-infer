...
| + CUDA-graph decode | ✅ Landed | Eager decode was host-bound (3,200 dispatches, 65 syncs/step). Static sync-free step + graph capture: **decode 5.3–5.5× (short ctx), 4.0–4.2× (long)**, weights streamed at **60% of peak** (was 10.9%). Syncs alone: 1.00–1.20×. Contended-GPU run, ratios only. See PROGRESS 2026-09-16 |
